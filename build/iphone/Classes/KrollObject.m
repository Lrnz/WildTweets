...
//@interface Les2appObject : NSObject
//@end

@interface Les2appObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Les2appObject class]])
		{
			for (NSString *key in [[(Les2appObject*)o modules] allKeys])
			{
