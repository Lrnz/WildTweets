...
// in simulator we redefine to format for Les2app Developer console
...
{\
	NSString * exceptionName = [@"org.les2app." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.les2app";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UILes2appNativeItemNone = -1, 
	UILes2appNativeItemSpinner = -2,
	UILes2appNativeItemProgressBar = -3,
	
	UILes2appNativeItemSlider = -4,
	UILes2appNativeItemSwitch = -5,
	UILes2appNativeItemMultiButton = -6,
	UILes2appNativeItemSegmented = -7,
	
	UILes2appNativeItemTextView = -8,
	UILes2appNativeItemTextField = -9,
	UILes2appNativeItemSearchBar = -10,
	
	UILes2appNativeItemPicker = -11,
	UILes2appNativeItemDatePicker = -12,
	
	UILes2appNativeItemInfoLight = -13,
	UILes2appNativeItemInfoDark = -14,
	
	UILes2appNativeItemDisclosure = -15,
	
	UILes2appNativeItemContactAdd = -16
};
